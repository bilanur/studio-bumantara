...
<section class="map-section">
    <div class="section-header">
        <h2>Kunjungi Studio Kami</h2>
        <p>Temukan lokasi kami dan hubungi untuk konsultasi</p>
    </div>
        ...
        <div class="contact-cards">
            <div class="contact-card">
                ...
                <div class="contact-content">
                    <h3>Lokasi Studio</h3>
                    <p>Jl. Cendana Raya, Sampiran, Kec. Talun, 
     Kabupaten Cirebon, Jawa Barat 45171.</p>
                </div>
            </div>
